...
function register_user($register_data){
    ...
    email($register_data['email'], 'Activate your account', "Hello " . $register_data['firstname'].",\n\n You need to activate your account,use the link below:\n\nhttp://http://localhost/rankmylist_task/PHP%20Register%20and%20Login%20Tutorials%20by%20CodeCourse/PHP%20Tutorials%20Register%20&%20Login%20(Part%2014)%20Email%20Activation%20(Part%202)/activate.php?email=".$register_data['email']."&email_code=".$register_data['email_code']);
}
function user_count(){
    $link = mysqli_connect('localhost', 'root', '', 'a_database1');
